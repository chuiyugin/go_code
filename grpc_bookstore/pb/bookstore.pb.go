...
const file_bookstore_proto_rawDesc = "" +
	...
	"\x05shelf\x18\x01 \x01(\x03R\x05shelf\x12\x12\n" +
	"\x04book\x18\x02 \x01(\x03R\x04book2\x9d\x06\n" +
	"\tBookstore\x12Z\n" +
	...
	"\n" +
	"CreateBook\x12\x1c.bookstore.CreateBookRequest\x1a\x0f.bookstore.Book\"'\x82\xd3\xe4\x93\x02!:\x04book\"\x19/v1/shelves/{shelf}/books\x12_\n" +
	"\aGetBook\x12\x19.bookstore.GetBookRequest\x1a\x0f.bookstore.Book\"(\x82\xd3\xe4\x93\x02\"\x12 /v1/shelves/{shelf}/books/{book}\x12l\n" +
	"\n" +
	"DeleteBook\x12\x1c.bookstore.DeleteBookRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\"* /v1/shelves/{shelf}/books/{book}BL\n" +
	"%com.liwenzhou.blog.examples.bookstoreB\x0eBookstoreProtoP\x01Z\x11grpc_bookstore/pbb\x06proto3"
