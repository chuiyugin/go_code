...
const file_add_proto_rawDesc = "" +
	"\n" +
	"\tadd.proto\x12\x05proto\x1a\x1cgoogle/api/annotations.proto\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	"\x01x\x18\x01 \x01(\x05R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x05R\x01y\"%\n" +
	"\vAddResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x03R\x06result2X\n" +
	"\vCalcService\x12I\n" +
	"\x03Add\x12\x11.proto.AddRequest\x1a\x12.proto.AddResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/example/echoB\x0eZ\fserver/protob\x06proto3"
