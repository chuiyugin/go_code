...
func (x *GetTodoReply) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
const file_api_bubble_v1_todo_proto_rawDesc = "" +
	...
	"\bListTodo\x12\x1e.api.bubble.v1.ListTodoRequest\x1a\x1c.api.bubble.v1.ListTodoReply\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/todosB1\n" +
	"\rapi.bubble.v1P\x01Z\x1ekratos_bubble/api/bubble/v1;v1b\x06proto3"
...
var file_api_bubble_v1_todo_proto_depIdxs = []int32{
	0,  // 0: api.bubble.v1.ListTodoReply.data:type_name -> api.bubble.v1.todo
	1,  // 1: api.bubble.v1.Todo.CreateTodo:input_type -> api.bubble.v1.CreateTodoRequest
	3,  // 2: api.bubble.v1.Todo.UpdateTodo:input_type -> api.bubble.v1.UpdateTodoRequest
	5,  // 3: api.bubble.v1.Todo.DeleteTodo:input_type -> api.bubble.v1.DeleteTodoRequest
	7,  // 4: api.bubble.v1.Todo.GetTodo:input_type -> api.bubble.v1.GetTodoRequest
	9,  // 5: api.bubble.v1.Todo.ListTodo:input_type -> api.bubble.v1.ListTodoRequest
	2,  // 6: api.bubble.v1.Todo.CreateTodo:output_type -> api.bubble.v1.CreateTodoReply
	4,  // 7: api.bubble.v1.Todo.UpdateTodo:output_type -> api.bubble.v1.UpdateTodoReply
	6,  // 8: api.bubble.v1.Todo.DeleteTodo:output_type -> api.bubble.v1.DeleteTodoReply
	8,  // 9: api.bubble.v1.Todo.GetTodo:output_type -> api.bubble.v1.GetTodoReply
	10, // 10: api.bubble.v1.Todo.ListTodo:output_type -> api.bubble.v1.ListTodoReply
