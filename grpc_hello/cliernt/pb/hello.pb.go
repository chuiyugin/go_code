...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 后面数字表示字段的序号
...
const file_hello_proto_rawDesc = "" +
	...
	"\tBidiHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse(\x010\x01B\vZ\tclient/pbb\x06proto3"
